...
{
    [Collection(nameof(MyClassFixtureCollection))]
    public class MyClassCollectionTestsB
    {
        MyFixtureA myFixtureA;
        MyFixtureB myFixtureB;
        public MyClassCollectionTestsB(MyFixtureA myFixtureA, MyFixtureB myFixtureB)
        {
