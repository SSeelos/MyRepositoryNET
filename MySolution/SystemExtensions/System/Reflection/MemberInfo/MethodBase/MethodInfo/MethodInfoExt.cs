...
using SystemExtensions.Reflection;
using SystemExtensions.RegularExpressions;

namespace SystemExtensions.CompilerServices
{
    public static class MethodInfoExt
    {
        ...
        public static string Display(this MethodInfo methodInfo)
        {
            ...
            return (methodInfo as MethodBase).Display();
        }
    }
}
